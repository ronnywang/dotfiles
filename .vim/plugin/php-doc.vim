...
func! PhpDocClass()
    ...
    exe l:txtBOL . g:pdv_cfg_CommentHead . g:pdv_cfg_EOL
    let l:rowname = matchstr(l:classname, 'Row') != "" ? substitute(l:classname, '\(.*\)Row$', '\1', "g") : ""
    let l:resultsetname = matchstr(l:classname, 'ResultSet') != "" ? substitute(l:classname, '\(.*\)ResultSet$', '\1', "g") : ""

    if l:rowname != ""
	exe l:txtBOL . g:pdv_cfg_Comment1 . l:classname . " Row of " . l:rowname . g:pdv_cfg_EOL
    elseif l:resultsetname != ""
	exe l:txtBOL . g:pdv_cfg_Comment1 . l:classname . " ResultSet of " . l:rowname . g:pdv_cfg_EOL
    else
