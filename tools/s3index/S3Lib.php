...
class S3Lib
{
    ...
    protected static function getS3Obj()
    {
        if (!class_exists('AmazonS3')) {
            ...
            include(__DIR__ . '/sdk-1.6.0/sdk.class.php');
    ...
    public function buildIndex($target)
    {
        ...
        foreach($res->body->Contents as $file) {
            ...
            $table_tr[] = "<tr><td><a href=\"" . htmlspecialchars($name) . "\">" . htmlspecialchars($name) . "</a></td><td>" . date('Y/m/d H:i:s', $last_modified) . "</td><td>" . number_format(intval($file->Size)) . "</td></tr>";
        }
        ...
        $body .= "Total Size: " . number_format($total_size) . "<br>";
